// ChyrunSofialab11.3.1.cpp : This file contains the 'main' function. Program execution begins and ends there.
// Lab_11_3.cpp
// < Чирун Софія >
...
void CreateBIN(char* fname, Specialist* p, const int N)
{
	...
	string s; 
	fout << "==============================================================================================" << endl;
	fout << "| № | Прізвище | Курс |   Спеціальність   | Фізика | Математика | Інформатика | Середній бал |" << endl;
	fout << "----------------------------------------------------------------------------------------------" << endl;
	for (int i = 0; i < N; i++)
	{
...
{ 
	...
	for (int i = 0; i < N; i++)
	{
		...
		fout << "| " << setw(9) << left << p[I[i]].prizv
			...
			<< "| " << setw(11) << setprecision(2) << fixed << right << p[I[i]].progr << " | ";
